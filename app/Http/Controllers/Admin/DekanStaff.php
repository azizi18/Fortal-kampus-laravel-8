...
use Image;
use App\Models\Dekan_model;

class DekanStaff extends Controller
{
    // Main page
    public function index()
    {
        ...
        $mystaff             = new Dekan_model();
        $staff             = $mystaff->semua();
        $kategori_staff     = DB::table('kategori_staff')->orderBy('urutan', 'ASC')->get();

        $data = array(
            'title'                => 'Data Struktur Organisasi Dekan Universitas',
            'staff'            => $staff,
            'content'            => 'admin/dekanstaff/index'
        );
    ...
    public function detail($id_staff)
    {
        ...
        $data = array(
            ...
            'staff'             => $staff,
            'content'           => 'admin/dekanstaff/detail'
        );
        return view('admin/layout/wrapper', $data);
    }
    ...
    public function proses(Request $request)
    {
        ...
        if (isset($_POST['hapus'])) {
            ...
            return redirect('admin/dekanstaff')->with(['sukses' => 'Data telah dihapus']);
            ...
            return redirect('admin/dekanstaff')->with(['sukses' => 'Data kategori telah diubah']);
        }
    }
    ...
    public function tambah()
    {
        ...
        $data = array(
            'title'             => 'Tambah Struktur Organisasi Dekan Universitas',
            'kategori_staff'   => $kategori_staff,
            'content'           => 'admin/dekanstaff/tambah'
        );
        return view('admin/layout/wrapper', $data);
    }
    ...
    public function edit($id_staff)
    {
        ...
        $data = array(
            'title'             => 'Edit Struktur Organisasi Dekan Universitas',
            'staff'            => $staff,
            'kategori_staff'   => $kategori_staff,
            'content'           => 'admin/dekanstaff/edit'
        );
        return view('admin/layout/wrapper', $data);
    }
    ...
    public function tambah_proses(Request $request)
    {
        ...
        return redirect('admin/dekanstaff')->with(['sukses' => 'Data telah ditambah']);
    }
    ...
    public function edit_proses(Request $request)
    {
        ...
        if (!empty($image)) {
            ...
            // END UPLOAD
            $slug_staff = Str::slug($request->nama_staff . '-' . $request->jabatan, '-');
            DB::table('dekan_staff')->where('id_staff', $request->id_staff)->update([
                'id_user'               => Session()->get('id_user'),
                'nama_staff'            => $request->nama_staff,
                'slug_staff'            => $slug_staff,
                'nik'                    => $request->nik,
        ...
        return redirect('admin/dekanstaff')->with(['sukses' => 'Data telah diupdate']);
    }
    ...
    public function delete($id_staff)
    {
        ...
        DB::table('dekan_staff')->where('id_staff', $id_staff)->delete();
        return redirect('admin/dekanstaff')->with(['sukses' => 'Data telah dihapus']);
    }
}
