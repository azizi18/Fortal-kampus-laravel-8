...
class ProdiStaff extends Controller
{
    // Main page
    public function index()
    {
        ...
        $data = array(
            ...
            'content'            => 'admin/prodistaff/index'
        );
    ...
    public function detail($id_staff)
    {
        ...
        $data = array(
            ...
            'staff'             => $staff,
            'content'           => 'admin/prodistaff/detail'
        );
        return view('admin/layout/wrapper', $data);
    }
    ...
    public function proses(Request $request)
    {
        ...
        if (isset($_POST['hapus'])) {
            ...
            return redirect('admin/prodistaff')->with(['sukses' => 'Data telah dihapus']);
            ...
            return redirect('admin/prodistaff')->with(['sukses' => 'Data kategori telah diubah']);
        }
    }
    ...
    public function tambah()
    {
        ...
        $data = array(
            ...
            'kategori_staff'   => $kategori_staff,
            'content'           => 'admin/prodistaff/tambah'
        );
        return view('admin/layout/wrapper', $data);
    }
    ...
    public function tambah_proses(Request $request)
    {
        ...
        return redirect('admin/prodistaff')->with(['sukses' => 'Data telah ditambah']);
    }
    ...
    public function edit_proses(Request $request)
    {
        ...
        if (!empty($image)) {
            ...
            // END UPLOAD
            $slug_staff = Str::slug($request->nama_staff . '-' . $request->jabatan, '-');
            DB::table('prodi_staff')->where('id_staff', $request->id_staff)->update([
                'id_user'               => Session()->get('id_user'),
                'id_kategori_staff'     => $request->id_kategori_staff,
                'nama_staff'            => $request->nama_staff,
                'slug_staff'            => $slug_staff,
        ...
        return redirect('admin/prodistaff')->with(['sukses' => 'Data telah diupdate']);
    }
    ...
    public function delete($id_staff)
    {
        ...
        DB::table('prodi_staff')->where('id_staff', $id_staff)->delete();
        return redirect('prodistaff')->with(['sukses' => 'Data telah dihapus']);
    }
}
