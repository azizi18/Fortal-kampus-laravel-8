...
class Staff_model extends Model
{
    ...
    public function listing()
    {
        $query = DB::table('staff')
            ...
            ->select('staff.*', 'staff.slug_staff ', 'staff.nama_staff ')
            ->where(array('staff.status_staff' => 'Staff'))
            ->orderBy('id_staff', 'DESC')
            ->paginate(12);
        return $query;
    }
    ...
    //         ->join('kategori_staff', 'kategori_staff.id_kategori_staff', '=', 'staff.id_kategori_staff', 'LEFT')
    //         ->join('users', 'users.id_user', '=', 'staff.id_user', 'LEFT')
    //         ->select('staff.*', 'kategori_staff.slug_staff', 'kategori_staff.nama_kategori_staff', 'users.nama')
    //         ->where(array(
    //             'staff.id_kategori_staff'    => $id_kategori_staff,
