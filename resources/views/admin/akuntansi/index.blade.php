...
<div class="row">
    ...
    <div class="col-md-8">
        <form action="{{ asset('admin/akuntansi/cari') }}" method="get" accept-charset="utf-8">
            <br>
            <div class="input-group">
                ...
                <span class="input-group-btn btn-flat">
                    ...
                    <a href="{{ asset('admin/akuntansi/tambah') }}" class="btn btn-success">
...
<p class="mx-1">
    @include('admin/akuntansi/tambah-import')
   
    </p>
   
<form action="{{ asset('admin/akuntansi/proses') }}" method="post" accept-charset="utf-8">
    {{ csrf_field() }}
                ...
                <tr class="odd gradeX">
                    <td class="text-center">
                        <div class="icheck-primary">
                            <input type="checkbox" name="id_aku[]" value="<?php echo $akuntansi->id_aku; ?>"
                                id="check<?php echo $i; ?>">
                    ...
                    <td>
                        <div class="btn-group">
                            <a href="{{ asset('admin/akuntansi/edit/' . $akuntansi->id_aku) }}"
                                class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>

                            <a href="{{ asset('admin/akuntansi/delete/' . $akuntansi->id_aku) }}"
