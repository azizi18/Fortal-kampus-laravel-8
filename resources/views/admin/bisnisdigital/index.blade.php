...
<div class="row">
    ...
    <div class="col-md-8">
        <form action="{{ asset('admin/bisnisdigital/cari') }}" method="get" accept-charset="utf-8">
            <br>
            <div class="input-group">
                ...
                <span class="input-group-btn btn-flat">
                    ...
                    <a href="{{ asset('admin/bisnisdigital/tambah') }}" class="btn btn-success">
...
<p class="mx-1">
    @include('admin/bisnisdigital/tambah-import')
   
    </p>
   
<form action="{{ asset('admin/bisnisdigital/proses') }}" method="post" accept-charset="utf-8">
    {{ csrf_field() }}
                ...
                <tr class="odd gradeX">
                    <td class="text-center">
                        <div class="icheck-primary">
                            <input type="checkbox" name="id_bis[]" value="<?php echo $bisnis ->id_bis; ?>"
                                id="check<?php echo $i; ?>">
                    ...
                    <td>
                        <div class="btn-group">
                            <a href="{{ asset('admin/bisnisdigital/edit/' . $bisnis ->id_bis) }}"
                                class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
                            <a href="{{ asset('admin/bisnisdigital/delete/' . $bisnis ->id_bis) }}"
