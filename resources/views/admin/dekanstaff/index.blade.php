<div class="row">
    ...
    <div class="col-md-6">
        <form action="{{ asset('admin/dekanstaff/cari') }}" method="get" accept-charset="utf-8">
            <br>
            <div class="input-group">
                ...
                <span class="input-group-btn btn-flat">
                    ...
                    <a href="{{ asset('admin/dekanstaff/tambah') }}" class="btn btn-success">
...
<form action="{{ asset('admin/dekanstaff/proses') }}" method="post" accept-charset="utf-8">
    {{ csrf_field() }}
        ...
        <table id="example1" class="display table table-bordered table-sm" cellspacing="0" width="100%">
            ...
            <tbody>
                ...
                <tr class="odd gradeX">
                    ...
                    <td><a href="{{ asset('admin/dekanstaff/status_staff/' . $staff->status_staff) }}">
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <a href="{{ asset('admin/dekanstaff/edit/' . $staff->id_staff) }}"
                                class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
                            <a href="{{ asset('admin/dekanstaff/delete/' . $staff->id_staff) }}"
