...
<div class="row">
    ...
    <div class="col-md-8">
        <form action="{{ asset('admin/dkv/cari') }}" method="get" accept-charset="utf-8">
            <br>
            <div class="input-group">
                ...
                <span class="input-group-btn btn-flat">
                    ...
                    <a href="{{ asset('admin/dkv/tambah') }}" class="btn btn-success">
...
<p class="mx-1">
    @include('admin/dkv/tambah-import')
   
    </p>
   
<form action="{{ asset('admin/dkv/proses') }}" method="post" accept-charset="utf-8">
    {{ csrf_field() }}
                ...
                <tr class="odd gradeX">
                    <td class="text-center">
                        <div class="icheck-primary">
                            <input type="checkbox" name="id_dkv[]" value="<?php echo $dkv->id_dkv; ?>"
                                id="check<?php echo $i; ?>">
                    ...
                    <td>
                        <div class="btn-group">
                            <a href="{{ asset('admin/dkv/edit/' . $dkv->id_dkv) }}"
                                class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>

                            <a href="{{ asset('admin/dkv/delete/' . $dkv->id_dkv) }}"
