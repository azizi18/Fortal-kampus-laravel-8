...
<div class="row">
    ...
    <div class="col-md-8">
        <form action="{{ asset('admin/farmasi/cari') }}" method="get" accept-charset="utf-8">
            <br>
            <div class="input-group">
                ...
                <span class="input-group-btn btn-flat">
                    ...
                    <a href="{{ asset('admin/farmasi/tambah') }}" class="btn btn-success">
...
<p class="mx-1">
    @include('admin/farmasi/tambah-import')
   
    </p>
   
<form action="{{ asset('admin/farmasi/proses') }}" method="post" accept-charset="utf-8">
    {{ csrf_field() }}
                ...
                <tr class="odd gradeX">
                    <td class="text-center">
                        <div class="icheck-primary">
                            <input type="checkbox" name="id_farm[]" value="<?php echo $farmasi->id_farm; ?>"
                                id="check<?php echo $i; ?>">
                    ...
                    <td>
                        <div class="btn-group">
                            <a href="{{ asset('admin/farmasi/edit/' . $farmasi->id_farm) }}"
                                class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>

                            <a href="{{ asset('admin/farmasi/delete/' . $farmasi->id_farm) }}"
