<p class="text-right">
    <a href="{{ asset('admin/farmasi') }}" class="btn btn-success btn-sm"><i class="fa fa-backward"></i> Kembali</a>
</p>
<hr>
...
<form action="{{ asset('admin/farmasi/tambah_proses') }}" method="post" enctype="multipart/form-data"
