...
<div class="row">
    ...
    <div class="col-md-8">
        <form action="{{ asset('admin/gizi/cari') }}" method="get" accept-charset="utf-8">
            <br>
            <div class="input-group">
                ...
                <span class="input-group-btn btn-flat">
                    ...
                    <a href="{{ asset('admin/gizi/tambah') }}" class="btn btn-success">
...
<p class="mx-1">
    @include('admin/gizi/tambah-import')
   
    </p>
   
<form action="{{ asset('admin/gizi/proses') }}" method="post" accept-charset="utf-8">
    {{ csrf_field() }}
                ...
                <tr class="odd gradeX">
                    <td class="text-center">
                        <div class="icheck-primary">
                            <input type="checkbox" name="id_giz[]" value="<?php echo $gizi->id_giz; ?>"
                                id="check<?php echo $i; ?>">
                    ...
                    <td>
                        <div class="btn-group">
                            <a href="{{ asset('admin/gizi/edit/' . $gizi->id_giz) }}"
                                class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>

                            <a href="{{ asset('admin/gizi/delete/' . $gizi->id_giz) }}"
