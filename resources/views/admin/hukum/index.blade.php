...
<div class="row">
    ...
    <div class="col-md-8">
        <form action="{{ asset('admin/hukum/cari') }}" method="get" accept-charset="utf-8">
            <br>
            <div class="input-group">
                ...
                <span class="input-group-btn btn-flat">
                    ...
                    <a href="{{ asset('admin/hukum/tambah') }}" class="btn btn-success">
...
<p class="mx-1">
    @include('admin/hukum/tambah-import')
   
    </p>
   
<form action="{{ asset('admin/hukum/proses') }}" method="post" accept-charset="utf-8">
    {{ csrf_field() }}
                ...
                <tr class="odd gradeX">
                    <td class="text-center">
                        <div class="icheck-primary">
                            <input type="checkbox" name="id_huk[]" value="<?php echo $hukum->id_huk; ?>"
                                id="check<?php echo $i; ?>">
                    ...
                    <td>
                        <div class="btn-group">
                            <a href="{{ asset('admin/hukum/edit/' . $hukum->id_huk) }}"
                                class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>

                            <a href="{{ asset('admin/hukum/delete/' . $hukum->id_huk) }}"
