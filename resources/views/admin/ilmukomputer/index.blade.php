...
<div class="row">
    ...
    <div class="col-md-8">
        <form action="{{ asset('admin/ilmukomputer/cari') }}" method="get" accept-charset="utf-8">
            <br>
            <div class="input-group">
                ...
                <span class="input-group-btn btn-flat">
                    ...
                    <a href="{{ asset('admin/ilmukomputer/tambah') }}" class="btn btn-success">
...
<p class="mx-1">
    @include('admin/ilmukomputer/tambah-import')
   
    </p>
   
<form action="{{ asset('admin/ilmukomputer/proses') }}" method="post" accept-charset="utf-8">
    {{ csrf_field() }}
                ...
                <tr class="odd gradeX">
                    <td class="text-center">
                        <div class="icheck-primary">
                            <input type="checkbox" name="id_ilkom[]" value="<?php echo $ilkom->id_ilkom; ?>"
                                id="check<?php echo $i; ?>">
                    ...
                    <td>
                        <div class="btn-group">
                            <a href="{{ asset('admin/ilmukomputer/edit/' . $ilkom->id_ilkom) }}"
                                class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>

                            <a href="{{ asset('admin/ilmukomputer/delete/' . $ilkom->id_ilkom) }}"
