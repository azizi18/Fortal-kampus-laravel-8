...
<div class="row">
    ...
    <div class="col-md-8">
        <form action="{{ asset('admin/manajemen/cari') }}" method="get" accept-charset="utf-8">
            <br>
            <div class="input-group">
                ...
                <span class="input-group-btn btn-flat">
                    ...
                    <a href="{{ asset('admin/manajemen/tambah') }}" class="btn btn-success">
...
<p class="mx-1">
    @include('admin/manajemen/tambah-import')
   
    </p>
   
<form action="{{ asset('admin/manajemen/proses') }}" method="post" accept-charset="utf-8">
    {{ csrf_field() }}
                ...
                <tr class="odd gradeX">
                    <td class="text-center">
                        <div class="icheck-primary">
                            <input type="checkbox" name="id_man[]" value="<?php echo $manajemen->id_man; ?>"
                                id="check<?php echo $i; ?>">
                    ...
                    <td>
                        <div class="btn-group">
                            <a href="{{ asset('admin/manajemen/edit/' . $manajemen->id_man) }}"
                                class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>

                            <a href="{{ asset('admin/manajemen/delete/' . $manajemen->id_man) }}"
