<p class="text-right">
    <a href="{{ asset('admin/prodistaff') }}" class="btn btn-success btn-sm">
...
<form action="{{ asset('admin/prodistaff/edit_proses') }}" method="post" enctype="multipart/form-data" accept-charset="utf-8">
    {{ csrf_field() }}
