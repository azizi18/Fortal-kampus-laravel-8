<div class="row">
    ...
    <div class="col-md-6">
        <form action="{{ asset('admin/prodistaff/cari') }}" method="get" accept-charset="utf-8">
            <br>
            <div class="input-group">
                ...
                <span class="input-group-btn btn-flat">
                    ...
                    <a href="{{ asset('admin/prodistaff/tambah') }}" class="btn btn-success">
...
<form action="{{ asset('admin/prodistaff/proses') }}" method="post" accept-charset="utf-8">
    {{ csrf_field() }}
        ...
        <table id="example1" class="display table table-bordered table-sm" cellspacing="0" width="100%">
            ...
            <tbody>
                ...
                <tr class="odd gradeX">
                    ...
                    <td><img src="{{ asset('assets/upload/staff/thumbs/' . $staff->gambar) }}"
                            class="img img-thumbnail img-fluid" width="80"></td>
                    ...
                    <td><a
                            href="{{ asset('admin/prodistaff/kategori/' . $staff->id_kategori_staff) }}"><?php echo $staff->nama_kategori_staff; ?></a>
                    </td>
                    <td><a href="{{ asset('admin/prodistaff/status_staff/' . $staff->status_staff) }}">
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <a href="{{ asset('admin/prodistaff/edit/' . $staff->id_staff) }}"
                                class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
                            <a href="{{ asset('admin/prodistaff/delete/' . $staff->id_staff) }}"
