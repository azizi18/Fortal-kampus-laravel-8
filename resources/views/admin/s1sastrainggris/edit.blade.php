<p class="text-right">
    <a href="{{ asset('admin/s1sastrainggris') }}" class="btn btn-success btn-sm">
...
<form action="{{ asset('admin/s1sastrainggris/edit_proses') }}" method="post" enctype="multipart/form-data"
