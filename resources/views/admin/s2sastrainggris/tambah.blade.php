<p class="text-right">
    <a href="{{ asset('admin/s2sastrainggris') }}" class="btn btn-success btn-sm"><i class="fa fa-backward"></i> Kembali</a>
</p>
<hr>
...
<form action="{{ asset('admin/s2sastrainggris/tambah_proses') }}" method="post" enctype="multipart/form-data"
