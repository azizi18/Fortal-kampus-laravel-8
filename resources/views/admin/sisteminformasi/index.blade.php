...
<div class="row">
    ...
    <div class="col-md-8">
        <form action="{{ asset('admin/sisteminformasi/cari') }}" method="get" accept-charset="utf-8">
            <br>
            <div class="input-group">
                ...
                <span class="input-group-btn btn-flat">
                    ...
                    <a href="{{ asset('admin/sisteminformasi/tambah') }}" class="btn btn-success">
...
<p class="mx-1">
    @include('admin/sisteminformasi/tambah-import')
   
    </p>
   
<form action="{{ asset('admin/sisteminformasi/proses') }}" method="post" accept-charset="utf-8">
    {{ csrf_field() }}
                ...
                <tr class="odd gradeX">
                    <td class="text-center">
                        <div class="icheck-primary">
                            <input type="checkbox" name="id_si[]" value="<?php echo $sistem->id_si; ?>"
                                id="check<?php echo $i; ?>">
                    ...
                    <td>
                        <div class="btn-group">
                            <a href="{{ asset('admin/sisteminformasi/edit/' . $sistem->id_si) }}"
                                class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>

                            <a href="{{ asset('admin/sisteminformasi/delete/' . $sistem->id_si) }}"
