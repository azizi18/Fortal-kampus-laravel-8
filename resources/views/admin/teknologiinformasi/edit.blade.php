<p class="text-right">
    <a href="{{ asset('admin/teknologiinformasi') }}" class="btn btn-success btn-sm">
...
<form action="{{ asset('admin/teknologiinformasi/edit_proses') }}" method="post" enctype="multipart/form-data"
    ...
    <div class="row form-group">
        ...
        <div class="col-md-6">
            <input type="text" name="nidn" class="form-control" placeholder="NIDN"
                required="required" value="<?php echo $ti->nidn; ?>">
        </div>
    </div>
    <div class="row form-group">
        ...
        <div class="col-md-6">
            <input type="text" name="nik_nip" class="form-control" placeholder="NIK/NIP"
                required="required" value="<?php echo  $ti->nik_nip; ?>">
        </div>
    </div>
    ...
    <div class="row form-group">
        ...
        <div class="col-md-6">
            <input type="text" name="nama" class="form-control" placeholder="Nama"
                required="required" value="<?php echo  $ti->nama; ?>">
        </div>
    </div>  
    ...
    <div class="row form-group">
        ...
        <div class="col-md-6">
            <input type="email" name="email" class="form-control" placeholder="Email"
                required="required" value="<?php echo  $ti->email; ?>">
        </div>
    </div>
