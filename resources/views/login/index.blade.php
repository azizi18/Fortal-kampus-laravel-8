        ...
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <div class="text-center">
                    <hr>
                    <h4 class="fw-bold">Universitas Bumigora</h4>
                    <hr>
                </div>
                <div class="login-logo">

                    <img src="assets/img/ubg.png" class="img img-responsive" style="width: auto; max-width: 50%;">

                </div>
                <p class="login-box-msg">Silahkan Login Ke Administrator</p>
