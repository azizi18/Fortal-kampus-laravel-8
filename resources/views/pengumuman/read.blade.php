...
@section('content')
    <section id="pengumuman" class="isi-mahasiswa">
        <div class="container">
                    ...
                    <p><?php echo $read->nama; ?>| <?php echo date('M d Y ', strtotime($read->tanggal_publish)); ?> |<?php echo $read->jenis_pengumuman; ?> | 0
                        comments
                    </p>
                    <div class="berita" href="#faq1">
                        <a href="">
                            <h4 class="fw-bold"><i class="bi bi-camera-fill icon-camera"> </i><?php echo $read->judul_pengumuman; ?>
                            </h4>
                        </a>
                    </div>

                    <h6 class="mt-4"><?php echo $read->isi; ?></h6>
                ...
                <div class="row mt-4" data-aos="fade-up" data-aos-delay="100">
                    <?php foreach($related->take(3) as $related) { ?>
                        <div class="col-md-4 ">
                            ...
                            <div class="berita" href="#faq1">
                                <a href="">
                                    <h6 class="fw-bold"><?php echo $related->judul_pengumuman; ?>
                                    </h6>
                                </a>
                                
                                <div style="font-size: 12px"> <?php echo date('M d Y ', strtotime($related->tanggal_publish));  ?>
                                </div>
                                <div style="font-size: 12px"> Ini "<?php echo $related->jenis_pengumuman; ?>"
                                </div>    
                            </div>
                        ...
                        <div class="share d-flex justify-content-end gap-4">
                            <div class="post">
                                <!-- Konten post lainnya di sini -->
                                <div class="share-icon">
                                    <i class="fas fa-share-alt"></i>
                                    <div class="share-container">
                                    {!! $shareButton_pengumuman !!}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 mt-4">
                                ...
                                <div class="berita" href="#faq1">
                                    <a href="{{ asset('pengumuman/read/' . $related_post->slug_pengumuman) }}">
                                        <h4 class="fw-bold"><?php echo $related_post->judul_pengumuman; ?>
                                        </h4>
                                    </a>
                                </div>
